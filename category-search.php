            ...
            <div id="layoutDefault_content">
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php">AMS</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><img src="img/menu.png" style="height:20px;width:25px" /><i data-feather="menu"></i></button>
                    ...
                    <?php 
                        if(isset($_POST['search-keyword'])) {
                            $url = "http://localhost/clgconnect/category-search.php?key=".$_POST['search-keyword']."&cat_id=".$_POST['category-id'];
                            header("Location: {$url}");
                        }
                    ?>
                                                ...
                                                <a class="card post-preview lift h-100" href="single.php?post_id=<?php echo $post_id; ?>"
                                                    ...
                                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                                        <div class="post-preview-meta">
                                                            <img class="post-preview-meta-img" src="./img/logo.jpg" />
                ...
                <footer class="footer pt-4 pb-4 mt-auto bg-dark footer-dark">
                    <div class="container">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 small">Copyright &#xA9; Aayush 2020</div>
